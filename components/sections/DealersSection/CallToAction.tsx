        ...
        >
          ...
          <div className="relative z-10 flex flex-col items-center justify-center gap-4 px-6 py-12 md:gap-6 md:py-16 lg:py-20">
            ...
            <Link href="/getAOffer">
              ...
              size="lg"
              className="rounded-full cursor-pointer bg-linear-to-r from-[#D93E39] to-[#D93E39] px-8 py-3 text-base font-medium text-white shadow-lg transition-all hover:scale-105 hover:shadow-xl md:px-10 md:text-lg"
            >
              {buttonText}
            </Button>
            </Link>
